...
//       _provider.getOpenClassList("cj1mS7", "0", "10");  // Adjust as necessary
//     });
//   }
//
//   @override
...
class _OpenClassListViewState extends State<OpenClassListView> {
  ...
  void _loadPage(int page) {
    _provider.getOpenClassList("YztDTs", page.toString(), _pageSize.toString(), replace: true);  // Pass `replace: true`
    setState(() {
      _currentPage = page;
    });
  }
