...
class _CreateClassState extends State<CreateClass> {
  ...
  void _createClass(ManageClassProvider provider) {
    if (_formKey.currentState!.validate() && _startDate != null && _endDate != null ) {
      ...
      final request = ClassCreateRequest(token: UserPreferences.getToken() ?? "", classId: _classCodeController.text, className: _classNameController.text, classType: _selectedSemester, startDate: startDate, endDate: endDate, maxStudentAmount: int.parse(_maxStudentsController.text));
      provider.createClass(request, context);
